...
const products: Product[] = [
  {
      id: 1,
      name: 'Senior Digital Artist (CEO)',
      href: '#',
      imageSrc: '/mentor/boy1.svg',
      imageAlt: "Front of men's Basic Tee in black.",
      color: 'Thathsara Dhananjaya',
  },
  {
      id: 2,
      name: 'Photoshop Instructor',
      href: '#',
      imageSrc: '/mentor/boy2.svg',
      imageAlt: "Front of men's Basic Tee in black.",
  ...
  return (
    <div id="mentors-section" className="mx-auto max-w-2xl pb-16 px-4 sm:py-20 sm:px-6 lg:max-w-7xl lg:px-8">
                ...
                <div className='sm:flex justify-between items-center mb-12'>
                    <h2 className="text-3xl sm:text-5xl font-bold tracking-tight text-gray-900 my-4">MEET WITH OUR TEAM</h2>
                    <div>
